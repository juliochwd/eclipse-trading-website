    ...
    if (hamburger) {
        hamburger.addEventListener('click', function () {
            ...
            if (!mobileMenu) {
                ...
                Array.from(navMenu.childNodes).forEach(child => mobileMenu.appendChild(child.cloneNode(true)));
                Array.from(navCta.childNodes).forEach(child => mobileMenu.appendChild(child.cloneNode(true)));
